        ...
        newRow.innerHTML = `
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" name="section_${sectionCounter}" class="form-control txt16 shadow-none mt-3" placeholder="หัวข้อ" required>
            ...
            <div class="col-md-6">
                <div class="form-floating ">
                    <textarea name="subhead_${sectionCounter}" class="form-control txt16 shadow-none mt-3" placeholder="หัวข้อย่อย"></textarea>
