        ...
        newRow.innerHTML = `
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" name="section_${sectionCounter}" class="form-control txt16 shadow-none" placeholder="หัวข้อ" required>
                    <label class="text-secondary txt16">หัวข้อ</label>
                    <div class="invalid-feedback">กรุณากรอกข้อมูล</div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-floating mt-3">
                    <textarea name="subhead_${sectionCounter}" class="form-control txt16 shadow-none" placeholder="หัวข้อย่อย"></textarea>
                    <label class="text-secondary txt16">หัวข้อย่อย</label>
                </div>
            </div>
...
function updatePreview(event, index) {
    ...
    console.log(`ไฟล์ที่เลือก:`, file); // ✅ Debug ดูว่ามีไฟล์ถูกเลือกหรือไม่
    if (file) {
